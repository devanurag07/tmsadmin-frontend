                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center space-x-2">
                                    <Badge variant={salonData?.is_active ? "default" : "secondary"}>
                            ...
                            {isEditingSecurity && newPassword && (
                                <div className="text-xs text-muted-foreground">
                                    {newPassword.length < 6 ? (
                                        ...
                                        <span className="text-green-500">Password meets minimum requirements</span>
                                    )}
                                </div>
                            )}
                        </div>
                        ...
                        {isEditingSecurity && (
                            <div className="flex justify-end space-x-4 pt-4">
                                ...
                                <Button
                                    ...
                                    disabled={loadingSecurity || !password || !newPassword || !confirmPassword || newPassword.length < 6}
                                >
